...
| 4 | 備品管理 | `EquipmentMasterService`, `MoveOutEquipmentService`, `EquipmentStorageService` |
...
#### 6.2.8 `equipment_moveout`（退去時備品処理）
